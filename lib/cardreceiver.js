...
CardReceiver.prototype.getLists = function(filter, callback) {
	...
	console.log('getLists: ' + this.trello.uri + '/1/boards/' + this.boardId + '/lists' + ', options=' + JSON.stringify(cardQuery));//, { query: cardQuery }, callback);
...
CardReceiver.prototype.getListCards = function(listId, callback) {
	...
	console.log('getListCards: ' + this.trello.uri + '/1/lists/' + listId + '/cards' + ', options=' + JSON.stringify(cardQuery));//, { query: cardQuery }, callback);
